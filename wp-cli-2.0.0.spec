...
%prep
wget -nv -O %{SOURCE0} "https://github.com/wp-cli/wp-cli/releases/download/v2.0.0/wp-cli-2.0.0.phar"
chmod +x %{SOURCE0}
{
    echo '.TH "WP" "1"'
    php %{SOURCE0} --help
...
%changelog
* Fri Aug 17 2018 Murtaza Sarıaltun <murtaza.sarialtun@ozguryazilim.cpm.tr> - 2.0.0-1
